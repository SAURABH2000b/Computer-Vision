...
%%EACH FEATURES (BINS) IN THE HISTOGRAM, BUT THIS IS A COMPUTATIONALLY HEAVY
%TASK TO COMPUTE THESE VALUES FOR ABOUT 100S OF IMAGES EACH WITH MILLIONS OF
%PIXELS, SO FOR NOW I'AM ASSUMING NORMALIZED EUCLIDEAN DISTANCE IS SAME
